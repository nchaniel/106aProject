...
class UR7e_CubeGrasp(Node):
    ...
    def cube_callback(self, cube_pose):
        ...
        self.job_queue.append(self.ik_planner.compute_ik(self.joint_state, self.cube_pose.point.x-0.01,self.cube_pose.point.y,self.cube_pose.point.z+0.175))
        ...
        '''
        self.job_queue.append(self.ik_planner.compute_ik(self.joint_state, self.cube_pose.point.x-0.01,self.cube_pose.point.y,self.cube_pose.point.z+0.095))
        ...
        self.job_queue.append(self.ik_planner.compute_ik(self.joint_state, self.cube_pose.point.x,self.cube_pose.point.y,self.cube_pose.point.z+0.185))
        ...
        '''
        self.job_queue.append(self.ik_planner.compute_ik(self.joint_state, self.cube_pose.point.x+0.3,self.cube_pose.point.y,self.cube_pose.point.z+0.14))
